/*
  ...
  gengetopt --input=generate.ggo --unnamed-opts --include-getopt  --file-name=generate_cmdline
...
#include "generate_cmdline.h"

const char *gengetopt_args_info_purpose = "Lab7 2024 osisp";

const char *gengetopt_args_info_usage = "Usage: generate [OPTION]... [FILE]...";
